...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonGroup.addButton(self.button_Start_Exam)
        self.verticalLayout.addWidget(self.button_Start_Exam, QtCore.Qt.AlignLeft)
        self.button_Exit = QtGui.QPushButton(Dialog)
        self.button_Exit.setObjectName(_fromUtf8("button_Exit"))
        self.buttonGroup.addButton(self.button_Exit)
        self.verticalLayout.addWidget(self.button_Exit, QtCore.Qt.AlignLeft)

        self.retranslateUi(Dialog)
        self.tabWidget.setCurrentIndex(8)
        self.tabWidget_UserAssist.setCurrentIndex(4)
